              ...
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>
                  <div className="filterItem">
                    ...
                    <Link
                      onClick={() => {
                        filterProduct('bookcasesShelving');
                      }}
                      to=""
                    >
                      Bookcases & Shelving
                    ...
                    <Link
                      onClick={() => {
                        filterProduct('cabinetsSideboards');
                      }}
                      to=""
                    >
                      Cabinets & Sideboards
                ...
                <Accordion.Body>
                  <div className="filterItem">
                    ...
                    <Link
                      to=""
                      onClick={() => {
                        filterProduct('GardenOutdoorlights');
                      }}
                    >
                ...
                <Accordion.Body>
                  <div className="filterItem">
                    <Link
                      to=""
                      onClick={() => {
                        filterProduct('gardenDiningSets');
                      }}
                    >
                      Garden Dining Sets
                    </Link>
                    ...
                    <Link
                      to=""
                      onClick={() => {
                        filterProduct('gardenLoungeSets');
                      }}
                    >
                      Garden Lounge Sets
                    </Link>
                    <br />
                    <Link to="/furnitureAndLighting/ShopLighting">New in: Lighting</Link>
                    <br />
                  </div>
                </Accordion.Body>
              </Accordion.Item>
