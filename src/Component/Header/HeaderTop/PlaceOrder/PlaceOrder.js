        ...
        <Row>
          <Col md={6} xs={12}>
            <Carousel showArrows={true}>
              <div>
                <div>
                  <InnerImageZoom zoomScale={2} width={750} height={500} zoomType="hover" zoomPreload={true} fullscreenOnMobile={true} src={product.img}>
                    <img src={product.img} alt="" />
                  </InnerImageZoom>
                </div>
              </div>
              <div>
                <InnerImageZoom zoomScale={2} width={750} height={500} zoomType="hover" zoomPreload={true} fullscreenOnMobile={true} src={product.img1} />
              </div>
              <div>
                <InnerImageZoom zoomScale={2} width={750} height={500} zoomType="hover" zoomPreload={true} fullscreenOnMobile={true} src={product.img2} />
              </div>
              <div>
                <InnerImageZoom zoomScale={2} width={750} height={500} zoomType="hover" zoomPreload={true} fullscreenOnMobile={true} src={product.img3} />
              </div>
            </Carousel>
          </Col>
          ...
          >
            ...
            <Row>
              <Col md={6} xs={12}>
                <Button style={{ width: '100%', margin: '5px 0' }} className="addToCartButton" variant="light" type="button" onClick={() => handleAddToCart(product)}>
                  Add To Basket
                </Button>
              </Col>
              <Col md={6} xs={12}>
                {
                  <Button style={{ width: '100%', margin: '5px 0' }} className="addToWishListButton" type="button" variant="light" onClick={() => handleAddToWishList(product)}>
                    {' '}
                    <span>
            ...
            >
              ...
              <div className="askQuote">
                <Link to="/" style={{ color: '#606060', textDecoration: 'none' }}>
                  {' '}
                  <span style={{ color: '#303030' }}>WANT A QUOTE?</span> <br />
                  Send Your Quote List For A Personalised Quotation
                </Link>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="askQuote">
                <Link to="/" style={{ color: '#606060', textDecoration: 'none' }}>
                  {' '}
                  <span style={{ color: '#303030' }}>COLLECT IN WAREHOUSE (BIRMINGHAM)</span> <br />
                  Store Details & Further Information
                </Link>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="askQuote">
                <Link to="/" style={{ color: '#606060', textDecoration: 'none' }}>
                  {' '}
                  <span style={{ color: '#303030' }}>NEED ADVICE OR URGENT ORDER?</span> <br />
                  Call 0800 1 223 023 or Request A Callback
                </Link>
              </div>
            </div>
            <Row>
              <Col md={6} xs={12}>
                <Button style={{ width: '100%', margin: '5px 0' }} className="askAQuestion" variant="light" type="button">
                  ASK A QUESTION
                </Button>
              </Col>
              <Col md={6} xs={12}>
                <Button style={{ width: '100%', margin: '5px 0' }} className="emailFriend" type="button" variant="light">
                  {' '}
                  EMAIL A FRIEND
                </Button>
              </Col>
          ...
          >
            <Tab style={{ color: '#606060', fontSize: '16px', margin: '30px' }} eventKey="productDetails" title="PRODUCT DETAILS">
              <p style={{ textAlign: 'justify' }}>
                {' '}
                <strong>Product Code: {product._id}</strong>{' '}
              </p>
            ...
            <Tab style={{ color: '#606060', fontSize: '16px', margin: '30px' }} eventKey="PaymentSecurity" title="PAYMENT & SECURITY">
              <p style={{ textAlign: 'justify', color: '#606060' }}>
                ...
                We accept online payment by Credit/Debit card (Visa, Mastercard & Maestro), PayPal or BACs. <br /> <br />{' '}
                <span
                  style={{
                    textDecoration: 'underline'
                  }}
                ...
                for further information regarding how your personal information is collected and used.
              </p>
            </Tab>
